// Package breaker 渠道×模型熔断器（DESIGN §5.5，FR-B1~FR-B6）。
//
...
// New 构造熔断引擎；参数非法时回落默认值（threshold 3 / cooldown 300s / max 3600s）
